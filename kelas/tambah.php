...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query = "INSERT INTO kelas (kode_kelas, tingkat, jurusan_id) VALUES ('$kode_kelas', '$tingkat','$jurusan_id')";

    $status = $db->modifikasi($query);

    if ($status) {
        $_SESSION['message'] = "Data berhasil diupdate.";
        echo "<div class='container'><p>Data Kelas berhasil ditambahkan.</p></div>";
