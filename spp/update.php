...
if (isset($_GET['id'])) {
    ...
    if ($data) {
        ...
        $_SESSION['message'] = "Data SPP tidak ditemukan.";
    ...
    <section class="section">
      <form method="POST" action="">
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="tahun" name="tahun" value="<?= htmlspecialchars($spp['tahun']) ?>" required>
        </div>
        <div class="form-group">
          <label for="nominal">Nominal</label>
          <input type="text" class="form-control" id="nominal" name="nominal" value="<?= htmlspecialchars($spp['nominal']) ?>" required>
        </div>
