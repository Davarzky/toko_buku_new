...
<body>
  ...
  <section class="section">
      <div class="container">
        <a href="tambah.php" class="btn btn-primary">Tambah Data Jurusan</a>
        <div class="row">
          <div class="col">
            <?php
            ...
            <div class="table-responsive">
              <table class="table table-bordered">
                ...
                <tbody id="tableBody">
                  ...
                  $countQuery = "SELECT COUNT(*) AS total FROM jurusan WHERE kode_jurusan LIKE '%$cari%' OR deskripsi LIKE '%$cari%'";
                  $totalData = $database->ambil_data($countQuery);
                  $totalData = $totalData[0]['total'];

                  $nextDisabled = ($totalData <= $maju) ? 'disabled' : '';

                  $query = "SELECT * FROM jurusan WHERE kode_jurusan LIKE '%$cari%' OR deskripsi LIKE '%$cari%' LIMIT $limit OFFSET $offset";
